...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create badge', href: route('acp.reputation.badges.create') },
];
...
const handleSubmit = () => {
    form.post(route('acp.reputation.badges.store'));
};
</script>
        ...
        <AdminLayout>
            <form class="flex flex-1 flex-col gap-6" @submit.prevent="handleSubmit">
                <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div>
                        <h1 class="text-2xl font-semibold tracking-tight">Create badge</h1>
                        <p class="text-sm text-muted-foreground">
                            Define a milestone that automatically awards members once they reach the required reputation.
                        </p>
                    </div>
                    ...
                    <CardContent class="space-y-6">
                        ...
                        <div class="grid gap-2">
                            ...
                            <Textarea
                                ...
                                placeholder="Explain when this badge is awarded so the community understands the milestone."
                                class="min-h-24"
                            />
